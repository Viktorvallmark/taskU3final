...
public class LPanel extends JPanel {
    ...
    private void setUp() {
        ...
        btnCreateNewCakeType.addActionListener(
                l -> {
                    mainFrame.buttonPressed(
                            ButtonType.MakeCake); // for grade VG: what happens if this button is pressed multiple
                                                  // times?
                });
    ...
    protected JButton getBtnShowCake() {
        return btnShowCake;
    }
    ...
    protected JButton getBtnCreateNewCakeType() {
        return btnCreateNewCakeType;
    }
