...
public class RPanel extends JPanel {
    ...
    /**
     * This method removes information in the panels list. There are some problems
     * with this in this
     * code and "ghost items" might appear in the list view at the top of the list
     * after use of this
     * method. This might throw selected indexes of synchronization if this is used.
     *
     * <p>
     * This is a "hack" and not a perfect solution - GUIs are annoying to work with!
     *
     * <p>
     * Several solutions have been tested but none worked to satisfaction. Please
     * notify teachers
     * if you might come across a solution that actually works well.
     */
